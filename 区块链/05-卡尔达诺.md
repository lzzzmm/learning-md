...
## 4、搭建私链——根据Cardano侧链搭建
官方没有明确的文档，但是根据侧链特点，侧链是可以作为私有区块链的。
有这个说法但是并找不到相关创建侧链的文档，但有找到搭建本地集群的文档（https://cardano-course.gitbook.io/cardano-course/handbook/setting-up-a-local-cluster/create-a-local-cluster ）感觉理论上是一样的，所以根据这个文档尝试搭建私链。
