...
### 4.3 其他节点加入私有区块链网络
#### 4.3.1 创建节点
这里就用虚拟机直接下载编译好的cardano-node，不再重复上面的步骤（因为虚拟机一直失败，详情看上面的报错图片）。
...
![2025-01-08-08-58-26.png](./images/2025-01-08-08-58-26.png)

接下来把管理节点上的配置传输给当前节点：

![2025-01-08-09-15-16.png](./images/2025-01-08-09-15-16.png)
